...
def summarize_history(
    patient_id: str, current_medication: str
) -> tuple[str, int, float]:
    """
        ...
        try:
            ...
            completion = _groq.chat.completions.create(
                messages=[
                    {
                        "role": "system",
                        "content": "You are a clinical history auditor specialized in pharmacogenomics.",
                    },
...
def _write_to_vault(patient_id: str, med: str, summary: str, history: str):
    ...
    try:
        ...
        with tempfile.NamedTemporaryFile(
            mode="w", dir=vault_dir, delete=False, encoding="utf-8", suffix=".tmp"
        ) as tmp_file:
        ...
        logger.info(
            f"Vault synchronized atomically: {file_path}",
